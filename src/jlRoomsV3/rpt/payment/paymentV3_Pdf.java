 ...
 * @author Lloyd
 */
public class paymentV3_Pdf extends objMgr implements Serializable {
...
cell1.setBackgroundColor(BaseColor.LIGHT_GRAY);
    ...
    public void getPayment(rptBeanColumesAmtList rpt, Document doc) throws DocumentException {
        ...
        float[] widths = {0.30f, 0.25f, 0.30f, 0.15f};
        PdfPTable table = new PdfPTable(widths);
        table.setWidthPercentage(100); // percentage
        ...
        for (rptBeanColumes rptBeanColumes : ary) {
            ...
            table.addCell(jfac.getRptFont(rptBeanColumes.getCol04()));
