...
public class rpt_Itinerary_db implements Serializable {
    ...
    String email;
    rpt_Itinerary_sql rpt_Itinerary_sql = new rpt_Itinerary_sql();
    ...
    public List<rptItineraryBean> getCustomerItinerary_Booking(int cust, int sponsor, dbMgrInterface db) {
        return itinerary_Booking(rpt_Itinerary_sql.getItinerary_CustomerBooking(email), new Object[]{cust, sponsor}, db);
    }

    public List<rptItineraryBean> getFlt(int cust, int sponsor, int type, dbMgrInterface db) {
        return itinerary_Booking(rpt_Itinerary_sql.getFlt(email), new Object[]{cust, sponsor, type}, db);
    }

    // =======================================================================================================

    private List<rptItineraryBean> itinerary_Booking(String sql, Object[] obj, dbMgrInterface db) {
        ...
        try {
            ...
            while (rs.next()) {
                list.add(getRptItineraryBean(rs, cnt++));
            }
        } catch (Exception ex) {
    ...
    private rptItineraryBean getRptItineraryBean(CachedRowSet rs, int cnt) {
        ...
        try {
            ...
            b.setTicketInfo(rs.getString(38));
